...
class TestRobustPDBBuilder(unittest.TestCase):
    """Tests for the RobustPDBBuilder class.
    ...
    def test_header_record_ok(self):
        rec = pdb.RobustPDBBuilder.HeaderRecord(
...
class TestRobustPDBBuilderHeaderDate(unittest.TestCase):
    ...
    def assertExceptionRaisedOnInitialization(self, datestr):
        with self.assertRaises(AssertionError):
            pdb.RobustPDBBuilder.HeaderRecord(
