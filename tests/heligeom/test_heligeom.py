...
TEST_REF_2GLSAB_N6 = os.path.join(
    os.path.dirname(__file__), "data", "ref_2GLSAB-N6.pdb"
)
TEST_REF_2GLSAB_N3_Z = os.path.join(
    os.path.dirname(__file__), "data", "ref_2GLSAB-N3-Zalign.pdb"
)
